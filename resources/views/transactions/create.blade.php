...
<body>
        ...
        <div class="breadcrumb-container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">New Transactions</li>
                </ol>
            </nav>
        </div>
    ...
    <!-- your form fields -->
                        ...
                        <div class="form-section">
                            <h3 class="section-title">New Transactions</h3>


                            <div class="form-row">
                                <label class="form-label" for="type">Type</label>
                                <select class="form-select" class="form-control" name="type" id="type" required>
