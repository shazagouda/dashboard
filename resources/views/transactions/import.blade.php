...
<head>
  ...
  <title>Import Transactions - Bee Company</title>
      ...
      <div class="import-section">
        ...
        <form id="importForm" enctype="multipart/form-data">
          ...
          <div class="import-actions">
            <button type="button" class="cancel-btn" onclick="window.location.href='{{ route('transactions.index') }}'">
              Cancel
            </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      importForm.addEventListener('submit', function(e) {
        ...
        setTimeout(function() {
          ...
          /*
          fetch('process-Transaction-import.php', {
            method: 'POST',
            body: formData
          })
      ...
      document.getElementById('downloadTemplate').addEventListener('click', function(e) {
        ...
        // Create sample CSV content for Transactions
        const csvContent = 'Transaction Name,Description,Price,Default Quantity,SKU,Category\n' +
