...
<body>
 ...
 <button class="save-btn" onclick="document.getElementById('editClientForm').submit();">Save</button>
</div>
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="group" name="group">
          ...
          <option value="vip" {{ old('group', $client->group) == 'vip' ? 'selected' : '' }}>VIP</option>
          <option value="standard" {{ old('group', $client->group) == 'standard' ? 'selected' : '' }}>Standard</option>
          <option value="premium" {{ old('group', $client->group) == 'premium' ? 'selected' : '' }}>Premium</option>
        </select>
      </div>
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="user" name="user">
          <option value="">Select...</option>
          <option value="admin" {{ old('user', $client->user) == 'admin' ? 'selected' : '' }}>Admin</option>
          <option value="user" {{ old('user', $client->user) == 'user' ? 'selected' : '' }}>User</option>
        </select>
      </div>

      <div class="form-group">
        <label class="form-label" for="id_number">ID Number</label>
        <input type="text" class="form-control" id="id_number" name="id_number" value="{{ old('id_number', $client->id_number) }}">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="url" class="form-control" id="website" name="website" value="{{ old('website', $client->website) }}">
      </div>

      <div class="form-group">
        <label class="form-label" for="phone">Phone</label>
        <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('phone', $client->phone) }}">
      </div>

      <div class="form-group">
        <label class="form-label" for="routing_id">Routing ID</label>
        <input type="text" class="form-control" id="routing_id" name="routing_id" value="{{ old('routing_id', $client->routing_id) }}">
      </div>

      <div class="toggle-group">
        <label class="form-label">Valid VAT Number</label>
        <label class="toggle-switch">
          <input type="checkbox" id="valid_vat" name="valid_vat" {{ old('valid_vat', $client->valid_vat) ? 'checked' : '' }}>
      ...
      <div class="toggle-group">
        ...
        <label class="toggle-switch">
          <input type="checkbox" id="tax_exempt" name="tax_exempt" {{ old('tax_exempt', $client->tax_exempt) ? 'checked' : '' }}>
          <span class="toggle-slider"></span>
        </label>
      </div>
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="classification" name="classification">
          <option value="">Select...</option>
          <option value="individual" {{ old('classification', $client->classification) == 'individual' ? 'selected' : '' }}>Individual</option>
          <option value="business" {{ old('classification', $client->classification) == 'business' ? 'selected' : '' }}>Business</option>
          <option value="non-profit" {{ old('classification', $client->classification) == 'non-profit' ? 'selected' : '' }}>Non-Profit</option>
        </select>
      </div>
    </div>
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        ...
        <input type="tel" class="form-control" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $client->contact_phone) }}">
      </div>

      <div class="toggle-group">
        <label class="form-label">Add to Invoices</label>
        <label class="toggle-switch">
          <input type="checkbox" id="add_to_invoices" name="add_to_invoices" {{ old('add_to_invoices', $client->add_to_invoices) ? 'checked' : '' }}>
          <span class="toggle-slider"></span>
        </label>
      </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="billing_street" name="billing_street" value="{{ old('billing_street', $client->billing_street) }}">
              </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="shipping_street" name="shipping_street" value="{{ old('shipping_street', $client->shipping_street) }}">
              </div>

              <div class="form-group">
                <label class="form-label" for="shipping_apt_suite">Apt/Suite</label>
                <input type="text" class="form-control" id="shipping_apt_suite" name="shipping_apt_suite" value="{{ old('shipping_apt_suite', $client->shipping_apt_suite) }}">
              </div>

              <div class="form-group">
                <label class="form-label" for="shipping_city">City</label>
                <input type="text" class="form-control" id="shipping_city" name="shipping_city" value="{{ old('shipping_city', $client->shipping_city) }}">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="shipping_state_province" name="shipping_state_province" value="{{ old('shipping_state_province', $client->shipping_state_province) }}">
              </div>

              <div class="form-group">
                <label class="form-label" for="shipping_postal_code">Postal Code</label>
                <input type="text" class="form-control" id="shipping_postal_code" name="shipping_postal_code" value="{{ old('shipping_postal_code', $client->shipping_postal_code) }}">
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-select" id="shipping_country" name="shipping_country">
                  <option value="">Select...</option>
                  <option value="us" {{ old('shipping_country', $client->shipping_country) == 'us' ? 'selected' : '' }}>United States</option>
                  <option value="ca" {{ old('shipping_country', $client->shipping_country) == 'ca' ? 'selected' : '' }}>Canada</option>
                  <option value="uk" {{ old('shipping_country', $client->shipping_country) == 'uk' ? 'selected' : '' }}>United Kingdom</option>
                  <option value="de" {{ old('shipping_country', $client->shipping_country) == 'de' ? 'selected' : '' }}>Germany</option>
                  <option value="fr" {{ old('shipping_country', $client->shipping_country) == 'fr' ? 'selected' : '' }}>France</option>
                </select>
              </div>
            </div>
          </div>
