...
<body>
    ...
    <form action="{{ route('recurring_expense.update', $recurring_expense->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="main-content">
            ...
            <div class="breadcrumb-container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Update Recurring Expenses</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="panel">
                    ...
                    <div class="form-row">
                        ...
                        <select id="vendorSelect" class="form-control" name="vendor"
                            value="{{ $recurring_expense->vendor }}">
                    ...
                    <div class="form-row">
                        ...
                        <select id="clientSelect" class="form-control" name="client"
                            value="{{ $recurring_expense->client }}">
                    ...
                    <div class="form-row">
                        ...
                        <select id="projectSelect" class="form-control" name="project"
                            value="{{ $recurring_expense->project }}">
                    ...
                    <div class="form-row">
                        ...
                        <select id="categorySelect" class="form-control" name="category"
                            value="{{ $recurring_expense->category }}">
                            <option value="">-- Select Category --</option>
                            <option value="new">+ New Expense Category</option>
                        </select>
                    </div>
                    ...
                    <!--cend of ategory part-->
                    <div class="form-row">
                        <label>User</label>
                        <select name="user" value="{{ $recurring_expense->user }}"></select>
                    </div>
                    <div class="form-row">
                        <label>Amount</label>
                        <input type="number" name="amount" value="{{ $recurring_expense->amount }}" required>
                    </div>

                    <div class="form-row">
                        <label>Date</label>
                        <input type="date" name="date" value="{{ $recurring_expense->date }}" required>
                    </div>
                    <div class="form-row">
                        <label>Frequency</label>
                        <select name="frequency" value="{{ $recurring_expense->frequency }}">
                            <option>Daily</option>
                    ...
                    <div class="form-row">
                        ...
                        <input type="date" name="start_date" value="{{ $recurring_expense->start_date }}"
                            required>
                    </div>
                    <div class="form-row">
                        <label>Remaining Cycles</label>
                        <select name="remaining_cycle" value="{{ $recurring_expense->remaining_cycle }}">
            ...
            <div class="panel">
                ...
                <hr style="color:lightgray;">
                <label>Public Notes</label>
                <textarea name="publicnotes" value="{{ $recurring_expense->publicnotes }}"></textarea>
                <label>Private Notes</label>
                <textarea name="privatenotes" value="{{ $recurring_expense->privatenotes }}"></textarea>
            </div>
            ...
            <div class="panel">
                <div class="form-row">
                    ...
                    <a href="{{ route('tax.index') }}" style="padding-left: 50px;">Settings</a>
                </div>
            </div>
