    ...
    <div class="form-content">
      <div class="tab-content" id="invoiceTabsContent">
        <div class="tab-pane fade show active" id="create" role="tabpanel">
          <form action="{{ route('recurring-invoices.store') }}" method="POST" id="newInvoiceForm">
            @csrf
            <!-- Client Section -->
            ...
            <div class="invoice-details">
              <div class="invoice-details-left">
                <div class="form-group">
                  ...
                  <div class="date-input-group">
                    <input type="date" class="form-control" id="invoice_date" name="invoice_date" value="2025-08-01" required>
                ...
                <div class="form-group">
                  ...
                  <div class="date-input-group">
                    <input type="date" class="form-control" id="due_date" name="due_date" placeholder="dd/mm/yyyy">
                    <i class="bi bi-calendar calendar-icon"></i>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="partial_deposit" name="partial_deposit" min="0" step="0.01" value="0">
                </div>

                <div class="form-group">
                  <label class="form-label" for="subtotal">Subtotal</label>
                  <input type="number" class="form-control" id="subtotal" name="subtotal" min="0" step="0.01" value="0" >
                </div>

                <div class="form-group">
                  <label class="form-label" for="total">Total</label>
                  <input type="number" class="form-control" id="total" name="total" min="0" step="0.01" value="0" >
                </div>
              </div>
              ...
              <div class="invoice-details-right">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="paid_to_date" name="paid_to_date" min="0" step="0.01" value="0">
                </div>

                <div class="form-group">
                  <label class="form-label" for="balance_due">Balance Due</label>
                  <input type="number" class="form-control" id="balance_due" name="balance_due" min="0" step="0.01" value="0">
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="public_notes" name="public_notes" rows="3" placeholder="Notes visible to client"></textarea>
                  </div>

                  <div class="form-group">
                    <label class="form-label" for="terms">Terms</label>
                    <textarea class="form-control" id="terms" name="terms" rows="3" placeholder="Payment terms and conditions"></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="private_notes" name="private_notes" rows="3" placeholder="Internal notes (not visible to client)"></textarea>
                  </div>

                  <div class="form-group">
                    <label class="form-label" for="footer">Footer</label>
                    <textarea class="form-control" id="footer" name="footer" rows="3" placeholder="Invoice footer text"></textarea>
                  </div>
                </div>
              </div>
            </div>
