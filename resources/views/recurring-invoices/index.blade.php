...
<head>
  ...
  <title>Invoices - Bee Company</title>
  ...
  <div class="main-content">
    ...
    <div class="page-controls">
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./recurring-invoice-import'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Invoice Button -->
        <button class="new-invoice-btn" type="button" onclick="window.location.href='./recurring-invoices/create'">
      ...
      <table class="data-table">
        <thead>
          <tr>
            ...
            <th class="sortable date-column" style="text-align: right;">
    ...
    @forelse($invoices as $invoice)
        <tr>
            ...
            <td style="text-align: right;">{{ $invoice->created_at->format('Y-m-d') }}</td>
            <td style="text-align: right;">{{ $invoice->due_date }}</td>
            <td>
    <a href="{{ route('recurring-invoices.edit', $invoice->id) }}" class="btn btn-sm btn-info">Edit</a>
...
<button type="button"
        ...
        <tr>
            <td colspan="8">
                <div class="empty-state">
                    ...
                    <div class="empty-state-subtext">Start by creating your first invoice</div>
                </div>
            </td>
        </tr>
    @endforelse
  ...
  function confirmDelete(invoiceId) {
    ...
    form.action = `/recurring-invoices/${invoiceId}`;
